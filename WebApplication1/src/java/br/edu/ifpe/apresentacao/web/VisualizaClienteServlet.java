 ...
 * @author 1860915
 */
@WebServlet(name = "VisualizaClienteServlet", urlPatterns = {"/VisualizaClienteServlet"})
public class VisualizaClienteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet VisualizaClienteServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Cliente cadastrado</h1>");
            out.println("Codigo:"+cliente.getCodigo()+"<br/>");
            out.println("CPF:"+cliente.getCpf()+"<br/>");
            ...
            out.println("Data de Nascimento:"+cliente.getDataNascimento()+"<br/>");
            out.println("<a href='ApresentaClientesServlet'>voltar</a>");
            out.println("</body>");
            out.println("</html>");
        }
    }
