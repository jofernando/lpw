...
public class AlteraClienteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Cliente cliente = new Cliente(cod, cpf, nome, endereco, telefone, dataNascimento, email);
        
        Fachada.getInstance().alterar(cliente);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>O cliente "+nome+" foi alterado com sucesso</h1>");
