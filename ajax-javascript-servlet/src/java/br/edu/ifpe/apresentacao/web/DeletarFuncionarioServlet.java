...
public class DeletarFuncionarioServlet extends HttpServlet {
	...
	Funcionario f = Fachada.getInstance().
		recuperarFuncionario(Integer.parseInt(request.getParameter("codigo")));
	Fachada.getInstance().deletar(f);
	...
	try (PrintWriter out = response.getWriter()) {
	    ...
	    out.println("<html>");
	    out.println("<head>");
	    out.println("<title>DeletarFuncionario</title>");
	    out.println("</head>");
	    out.println("<body>");
	    out.println("<h1>Funcionario deletado, ou não, eis a questão</h1>");
	    out.println("</body>");
	    out.println("</html>");
	}
    }
