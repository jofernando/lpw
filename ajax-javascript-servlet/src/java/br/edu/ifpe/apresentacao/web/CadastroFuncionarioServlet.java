...
public class CadastroFuncionarioServlet extends HttpServlet {
	...
	Fachada.getInstance().inserir(new Funcionario(codigo, nome, funcao));
	...
	try (PrintWriter out = response.getWriter()) {
	    ...
	    out.println("<html>");
	    out.println("<head>");
	    out.println("<title>CadastroFuncionario</title>");
	    out.println("</head>");
	    out.println("<body>");
	    out.println("<h1>Funcionario cadastrado com sucesso, ou não, afinal não verifico</h1>");
	    out.println("</body>");
	    out.println("</html>");
	}
    }
