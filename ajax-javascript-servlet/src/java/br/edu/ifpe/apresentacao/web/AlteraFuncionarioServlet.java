...
public class AlteraFuncionarioServlet extends HttpServlet {
	...
	Funcionario f = new Funcionario(codigo, nome, funcao);

	Fachada.getInstance().alterar(f);
	...
	try (PrintWriter out = response.getWriter()) {
	    ...
	    out.println("<html>");
	    out.println("<head>");
	    out.println("<title>Servlet AlteraFuncionarioServlet</title>");
	    out.println("</head>");
	    out.println("<body>");
	    out.println("<h1>Funcionario alterado com sucesso</h1>");
	    out.println("</body>");
	    out.println("</html>");
	}
    }
